...
Item {
    ...
    ColumnLayout {
        ...
        ConfigSwitch {
            ...
            checked: Config.options.background.widgetsLocked ?? false
        ...
        Repeater {
            ...
            delegate: ConfigSwitch {
                ...
                text: modelData.name
                checked: Config.options.background.widgets[modelData.key]?.enable ?? false
                onCheckedChanged: {
                    if (Config.options.background.widgets[modelData.key]) {
